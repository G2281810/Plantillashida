...
<div class="right_col" role="main">
  <div class="control">
    <h1>ALTA DE TRATAMIENTOS </h1>
      ...
      <div class="x_content">
        <form action= "{{ route('guardartratamiento')}}" method="POST">
          {{csrf_field()}}
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="idtratamiento" value="{{$idsigue}}"
                readonly="readonly"/>
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Duración: <span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="duracion" value="{{old('duracion')}}"
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Medicamento: <span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="medicamento" value="{{old('medicamento')}}"
