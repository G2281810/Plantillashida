...
<div class="right_col" role="main">
  <div class="control">
    <h1>MODIFICAR MATERIAL ODONTOLÓGICO</h1>
        ...
        <form action= "{{ route('guardacambiosm')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="idmaterial" value="{{$consulta->idmaterial}}"
                readonly="readonly"/>
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Marca: <span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="marca" value="{{$consulta->marca}}"
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Fecha de registro:<span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" class='optional' name="fechareg" value="{{$consulta->fechareg}}" data-validate-length-range="5,15"
                type="date" />
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Hora de registro:<span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="horareg" value="{{$consulta->horareg}}"
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Piezas existentes:<span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="pzas_exis" value="{{$consulta->pzas_exis}}"
                placeholder="Ej: 20"/>
          ...
          <div class="field item form-group">
            <label class="col-form-label col-md-5 col-sm-5  label-align">Lote:<span
                class="text-danger">*</span></label>
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="lote" value="{{$consulta->lote}}"
