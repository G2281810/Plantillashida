...
<div class="right_col" role="main">
    <div class="control">
        ...
        <div class="x_content">
            <form action="{{route('guardarcambios_especialidades')}}" method="POST">
                {{csrf_field()}}
                <div class="field item form-group">
                    ...
                    <div class="col-md-5 col-sm-5">
                        ...
                        @endif
                        <input type="text" class="form-control" value="{{$consulta->idesp}}" readonly="readonly"name="idesp">
                    </div>
                </div>
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-5 col-sm-5">
                        ...
                        @endif
                        <input type="text" class="form-control" value="{{$consulta->especialidad}}" name="especialidad">
                    </div>
                </div>
