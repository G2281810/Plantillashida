...
<div class="right_col" role="main">
    <div class="control">
        <h1>ALTA TIPO DE MEDICAMENTOS</h1>
        <div class="x_content">
            <form action="{{route('guarda_tipomedicamentos')}}" method="POST">
                {{csrf_field()}}
                <div class="field item form-group">
                    ...
                    <div class="col-md-5 col-sm-5">
                        ...
                        @endif
                        <input type="text" class="form-control" value="{{$idesigue}}"  name="idtipomed">
                    </div>
                </div>
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-5 col-sm-5">
                        ...
                        @endif
                        <input type="text" class="form-control" value="{{old('tipo')}}" name="tipo">
                    </div>
                </div>
