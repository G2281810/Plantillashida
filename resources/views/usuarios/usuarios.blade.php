            ...
            <div class="modal-body">
              <form id="CustomerForm" name="CustomerForm" class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="numusuario" class="col-sm-2 control-label">Numero de usuario</label>
                    <div class="col-sm-12">
                      <input type="text" name="numusuario" id="numusuario" class="form-control" placeholder="Indique el numero de usuario" value="" maslenght="30" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label for="tipou" class="col-sm-2 control-label">Tipo de usuario</label>
                    <div class="col-sm-12">
                      <input type="text" name="tipou" id="tipou" class="form-control" placeholder="tipo de usuario" value="" required="">
                    </div>
                </div>
