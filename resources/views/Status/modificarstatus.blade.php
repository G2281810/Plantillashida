...
<div class="right_col" role="main">
  <div class="control">
    <h1>MODIFICAR ESTATUS </h1>
      ...
      <div class="x_content">
        <form action= "{{ route('guardacambioss')}}" method="POST">
          {{csrf_field()}}
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-5 col-sm-5">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="idstatus" value="{{$consulta->idstatus}}"
                readonly="readonly"/>
