      ...
      <div class="x_content">
          <div class="field item form-group">
           ...
           <div class="col-md-5 col-sm-5">
             <input type="text" name="idtiposan" id="idtiposan" value="{{$idsigue}}"  readonly='readonly' class="form-control" placeholder="Introduce clave del tipo de usuario" tabindex="5">
             @if($errors->first('idtipo'))
              <p class='text-danger'>{{$errors->first('idtiposan')}}</p>
             @endif
           </div>
          </div>
           <!--nombre -->
